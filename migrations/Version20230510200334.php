 ...
 */
final class Version20230510200334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidacy (id INT AUTO_INCREMENT NOT NULL, annonce_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_D930569D8805AB2F (annonce_id), INDEX IDX_D930569DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
