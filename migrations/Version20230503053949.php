 ...
 */
final class Version20230503053949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP type, CHANGE valited validated TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD type TINYINT(1) NOT NULL, CHANGE validated valited TINYINT(1) DEFAULT NULL');
    }
}
